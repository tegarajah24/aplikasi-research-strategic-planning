    ...
    <x-slot name="header">
        <div x-data class="flex items-center justify-between flex-wrap gap-3">
            ...
            <div class="flex items-center gap-3">
                <button @click="alert('Fitur Import akan segera hadir!')" class="inline-flex items-center justify-center px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition-colors shadow-sm">
