<div class="p-5 border-b border-slate-100">
    <div class="flex flex-col lg:flex-row gap-3 items-start lg:items-center">
        ...
        <div class="flex items-center gap-2 flex-wrap lg:ml-auto">
            ...
            {{-- Table & Export --}}
            <button @click="const t = document.getElementById('filter-tahun').value; if (t) { window.location = '?table_tahun=' + encodeURIComponent(t); } else { showTableModal = true; }"
                class="flex items-center gap-1.5 px-3 py-3 rounded-lg text-xs font-semibold bg-slate-100 text-slate-700 hover:bg-slate-200 transition-colors shrink-0 whitespace-nowrap">
