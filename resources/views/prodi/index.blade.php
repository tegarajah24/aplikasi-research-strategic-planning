        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm">
                ...
                <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <!-- Search Box -->
                    <form action="{{ route('prodi.index') }}" method="GET" class="relative max-w-sm w-full">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('prodi.export') }}" class="inline-flex items-center justify-center px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-blue-600 hover:bg-blue-50 transition-colors shadow-sm">
                        ...
                        <tbody class="divide-y divide-slate-100 bg-white">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="py-4 px-6 text-sm text-slate-700 border-r border-slate-100">
                                    {{ $item->fakultas ? $item->fakultas->nama_fakultas : '-' }}
                                </td>
        ...
        <div x-show="showEditModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showEditModal" x-transition.scale.origin.bottom class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-100">
                    <form :action="'{{ route('prodi.index') }}/' + editData.id" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    ...
                                    <div class="space-y-4">
                                        <div class="bg-blue-50 text-blue-700 p-3 rounded-lg text-sm mb-4">
                                            ...
                                            <strong>Kode Prodi, Nama Program Studi, Kode Fakultas</strong><br>
                                            *Baris pertama (header) akan diabaikan.<br>
                                            *Pastikan <strong>Kode Fakultas</strong> yang dimasukkan sudah ada di menu Fakultas.
                                        </div>
                                        <div>
