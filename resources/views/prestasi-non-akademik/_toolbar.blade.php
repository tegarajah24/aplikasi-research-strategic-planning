<div class="px-6 py-3 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
    ...
    <div class="flex items-center gap-3">
        ...
        @endif
        <a href="{{ route('prestasi-non-akademik.export') }}" data-no-loader class="inline-flex items-center justify-center px-4 bg-white border border-slate-200 rounded-lg py-3 text-xs font-semibold text-blue-600 hover:bg-blue-50 transition-colors shadow-sm whitespace-nowrap">
