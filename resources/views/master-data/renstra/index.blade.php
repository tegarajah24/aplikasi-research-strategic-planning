<x-app-layout>
            ...
            <div class="glass-panel shadow-sm">
                <div class="flex items-center justify-between gap-3 px-5 py-4 border-b border-slate-100 flex-wrap bg-slate-50/50">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        @endif
                        <a href="#" onclick="exportWithFilters('excel'); return false;"
                           data-no-loader
                        ...
                        <a href="#" onclick="exportWithFilters('word'); return false;"
                           data-no-loader
                           class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold text-white hover:opacity-90 transition shadow-sm"
    ...
    function exportWithFilters(type) {
        ...
        if (bidang) params.set('bidang_id', bidang);
        if (fakultas) params.set('fakultas_id', fakultas);
        const route = type === 'excel'
            ? '{{ route("renstra.export.excel") }}'
            : '{{ route("renstra.export.word") }}';
