                            ...
                            <tr>
                                <td colspan="10" class="py-12 px-6 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="mt-1 text-sm text-slate-500">Get started by adding a new cooperation or importing data.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
                ...
                <div x-show="showImportModal" x-transition.scale.origin.bottom class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-100">
                    <form action="{{ route('kerjasama.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    <h3 class="text-lg leading-6 font-semibold text-slate-900 mb-4 border-b pb-4">Import Data</h3>
                                    
                                    <div class="space-y-4">
                                        <div class="bg-blue-50 text-blue-700 p-3 rounded-lg text-sm mb-4">
                                            CSV format columns order: <br>
                                            <strong>Letter No., Date (YYYY-MM-DD), Partners, Type, Level, PIC, Department</strong><br>
                                            *First row (header) will be ignored.
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-slate-700">Select CSV/TXT File</label>
