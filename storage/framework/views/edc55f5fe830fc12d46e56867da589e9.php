...
<?php $component->withAttributes(['href' => '#','x-on:click.prevent' => '$root.submit();']); ?>
        <div class="flex items-center">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isCurrentTeam($team)): ?>
...
<?php /**PATH C:\laragon\www\aplikasi-research-strategic-planning\resources\views\components\switchable-team.blade.php ENDPATH**/ ?>