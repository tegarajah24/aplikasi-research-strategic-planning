            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
                ...
                <div class="xl:col-span-2 bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
                    ...
                    <div class="cal-grid border-b border-slate-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Min','Sen','Sel','Rab','Kam','Jum','Sab']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-center text-[11px] font-semibold text-slate-400 py-2 uppercase tracking-wider
                            <?php echo e($d === 'Min' ? 'text-red-400' : ''); ?>"><?php echo e($d); ?></div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\aplikasi-research-strategic-planning\resources\views\rkt\kalender\index.blade.php ENDPATH**/ ?>