        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
                ...
                <div class="dash-card bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-2xl font-bold text-slate-800 tracking-tight"><?php echo e($totalRegional); ?></p>
                ...
                <div class="dash-card bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-2xl font-bold text-slate-800 tracking-tight"><?php echo e($totalNasional); ?></p>
                ...
                <div class="dash-card bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-2xl font-bold text-slate-800 tracking-tight"><?php echo e($totalInternasional); ?></p>
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm">
                ...
                <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h2 class="text-lg font-semibold text-slate-800">Prestasi Non-Akademik</h2>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="<?php echo e(route('prestasi-non-akademik.export')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-blue-600 hover:bg-blue-50 transition-colors shadow-sm">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100 bg-white">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $prestasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $prestasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="py-4 px-6 text-sm text-slate-500 text-center border-r border-slate-100"><?php echo e($prestasis->firstItem() + $index); ?></td>
                                <td class="py-4 px-6 text-center font-medium text-slate-900 border-r border-slate-100"><?php echo e($prestasi->tahun); ?></td>
                                <td class="py-4 px-6 text-center text-slate-700 border-r border-slate-100"><?php echo e($prestasi->nama_mahasiswa ?? '-'); ?></td>
                                <td class="py-4 px-6 text-center text-slate-700 border-r border-slate-100"><?php echo e($prestasi->prodi ?? '-'); ?></td>
                                <td class="py-4 px-6 text-center text-slate-700 border-r border-slate-100"><?php echo e($prestasi->fakultas ?? '-'); ?></td>
                                <td class="py-4 px-6 text-center text-slate-700 border-r border-slate-100"><?php echo e($prestasi->regional); ?></td>
                                <td class="py-4 px-6 text-center text-slate-700 border-r border-slate-100"><?php echo e($prestasi->nasional); ?></td>
                                <td class="py-4 px-6 text-center text-slate-700 border-r border-slate-100"><?php echo e($prestasi->internasional); ?></td>
                                <td class="py-4 px-6 text-center font-semibold text-slate-900 border-r border-slate-100"><?php echo e($prestasi->regional + $prestasi->nasional + $prestasi->internasional); ?></td>
                                <td class="py-4 px-6 text-center">
                                    <div class="flex justify-center gap-2">
                                        <button @click="editData = <?php echo e(json_encode($prestasi)); ?>; showEditModal = true" class="p-1.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded transition-colors" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                        </button>
                                        <form action="<?php echo e(route('prestasi-non-akademik.destroy', $prestasi)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Hapus rekapitulasi prestasi tahun ini?');">
                                            <?php echo csrf_field(); ?>
                ...
                <!-- Pagination -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prestasis->hasPages()): ?>
        ...
        <div x-show="showCreateModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showCreateModal" x-transition.scale.origin.bottom class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-100">
                    <form action="<?php echo e(route('prestasi-non-akademik.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="number" name="tahun" value="<?php echo e(date('Y')); ?>" required class="mt-1 block w-full border-slate-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        </div>
                                        <div>
        ...
        <div x-show="showEditModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showEditModal" x-transition.scale.origin.bottom class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-100">
                    <form :action="'<?php echo e(route('prestasi-non-akademik.index')); ?>/' + editData.id" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\aplikasi-research-strategic-planning\resources\views\prestasi-non-akademik\index.blade.php ENDPATH**/ ?>