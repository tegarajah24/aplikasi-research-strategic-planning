            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm">
                ...
                <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="<?php echo e(route('prestasi-akademik.export')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-blue-600 hover:bg-blue-50 transition-colors shadow-sm">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="py-4 px-6 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="<?php echo e(route('prestasi-akademik.destroy', $prestasi)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Hapus rekapitulasi prestasi tahun ini?');">
                                            <?php echo csrf_field(); ?>
        ...
        <div x-show="showCreateModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showCreateModal" x-transition.scale.origin.bottom class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-100">
                    <form action="<?php echo e(route('prestasi-akademik.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
        ...
        <div x-show="showEditModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showEditModal" x-transition.scale.origin.bottom class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-100">
                    <form :action="'<?php echo e(route('prestasi-akademik.index')); ?>/' + editData.id" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\aplikasi-research-strategic-planning\resources\views\prestasi-akademik\index.blade.php ENDPATH**/ ?>